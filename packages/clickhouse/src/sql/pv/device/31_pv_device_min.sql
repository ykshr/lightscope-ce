CREATE TABLE IF NOT EXISTS lightscope.pv_device_min (
...
PRIMARY KEY (organization_id_hash, date, site_name, url_hash, device_type, device_vendor, device)
ORDER BY (organization_id_hash, date, site_name, url_hash, device_type, device_vendor, device)
SETTINGS
