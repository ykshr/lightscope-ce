...
- **Restrictions on libraries that should or should not be used**: Do not use any external ORM libraries other than Prisma for relational state. Do not add raw driver clients outside of ClickHouse.
