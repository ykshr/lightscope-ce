...
PRIMARY KEY (tenant_id_hash, date, site_name, url_hash, device_type, device_vendor, device)
ORDER BY (tenant_id_hash, date, site_name, url_hash, device_type, device_vendor, device)
SETTINGS
