CREATE TABLE IF NOT EXISTS lightscope.pv_hour (
...
PRIMARY KEY (organization_id_hash, date, site_name, url_hash)
ORDER BY (organization_id_hash, date, site_name, url_hash)
SETTINGS
