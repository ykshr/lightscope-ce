CREATE TABLE IF NOT EXISTS lightscope.pv_app_hour (
    tenant_id UInt64,
...
PRIMARY KEY (tenant_id, date, site_name, url_hash, app_type, app)
ORDER BY (tenant_id, date, site_name, url_hash, app_type, app)
SETTINGS
