CREATE TABLE IF NOT EXISTS lightscope.pv_geo_day (
...
PRIMARY KEY (tenant_id_hash, date, site_name, url_hash, geo_continent, geo_country, geo_subdivision, geo_city)
ORDER BY (tenant_id_hash, date, site_name, url_hash, geo_continent, geo_country, geo_subdivision, geo_city)
SETTINGS
