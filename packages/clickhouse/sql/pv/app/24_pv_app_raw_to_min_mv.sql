CREATE MATERIALIZED VIEW IF NOT EXISTS lightscope.pv_app_raw_to_min_mv
...
WHERE app_type != '' OR app != ''
GROUP BY organization_id_hash, date, site_name, url_hash, app_type, app;
