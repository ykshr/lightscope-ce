...
#### Restrictions
* Guardrails such as:
  - When creating temporary Node.js scripts that use CommonJS require(), use the .cjs extension to avoid ES module reference errors, as the package.json specifies "type": "module".
