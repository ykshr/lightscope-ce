CREATE TABLE IF NOT EXISTS lightscope.pv_gender_hour (
    tenant_id UInt64,
...
PRIMARY KEY (tenant_id, date, site_name, url_hash, gender)
ORDER BY (tenant_id, date, site_name, url_hash, gender)
SETTINGS
